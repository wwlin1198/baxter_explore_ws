...
if("TRUE" STREQUAL "TRUE")
  set(opencv_candidate_SOURCE_PREFIX /home/willy/ws/src/opencv_candidate)
  set(opencv_candidate_DEVEL_PREFIX /home/willy/ws/devel)
  ...
  set(opencv_candidate_INSTALL_PREFIX /home/willy/ws/install)
...
if(NOT "/home/willy/ws/src/opencv_candidate/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(opencv_candidate_INCLUDE_DIRS "")
  set(_include_dirs "/home/willy/ws/src/opencv_candidate/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_candidate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/willy/ws/src/opencv_candidate/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT opencv_candidate_NUM_DUMMY_TARGETS)
      set(opencv_candidate_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::opencv_candidate::wrapped-linker-option${opencv_candidate_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR opencv_candidate_NUM_DUMMY_TARGETS "${opencv_candidate_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::opencv_candidate::wrapped-linker-option${opencv_candidate_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND opencv_candidate_LIBRARIES "${interface_target_name}")
