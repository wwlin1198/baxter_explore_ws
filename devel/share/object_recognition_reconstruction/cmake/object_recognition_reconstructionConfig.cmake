...
if("TRUE" STREQUAL "TRUE")
  set(object_recognition_reconstruction_SOURCE_PREFIX /home/willy/ws/src/ork_reconstruction)
  set(object_recognition_reconstruction_DEVEL_PREFIX /home/willy/ws/devel)
  ...
  set(object_recognition_reconstruction_INSTALL_PREFIX /home/willy/ws/install)
...
if(NOT "/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/python2.7;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(object_recognition_reconstruction_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/python2.7;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'object_recognition_reconstruction' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/willy/ws/src/ork_reconstruction/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT object_recognition_reconstruction_NUM_DUMMY_TARGETS)
      set(object_recognition_reconstruction_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::object_recognition_reconstruction::wrapped-linker-option${object_recognition_reconstruction_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR object_recognition_reconstruction_NUM_DUMMY_TARGETS "${object_recognition_reconstruction_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::object_recognition_reconstruction::wrapped-linker-option${object_recognition_reconstruction_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND object_recognition_reconstruction_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/willy/ws/devel/lib;/home/willy/ws/devel/lib;/opt/ros/kinetic/lib)
